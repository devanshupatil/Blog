...
const SOCIAL_LINKS = [
  {
    label: 'GitHub',
    href: 'https://github.com/devanshupatil',
    icon: (
  ...
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/in/devanshu-patil-973334266/',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
  ...
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/devansh_u11/',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
...
const NAV_LINKS = [
  ...
  { label: 'Frontend', to: '/blog/frontend' },
  ...
  return (
    <footer className="border-t border-cream-border dark:border-[#1e1e1e] mt-16">
      <div className="max-w-5xl mx-auto px-4 py-12">
            ...
            <div className="flex flex-col gap-3">
              {SOCIAL_LINKS.map((s) => (
                <a
                  ...
                  className="flex items-center gap-2 text-sm text-editorial-muted hover:text-editorial-accent transition-colors"
                >
                  {s.icon}
                  {s.label}
                </a>
        ...
        {/* Bottom bar */}
        <div className="pt-6 border-t border-cream-border dark:border-[#1e1e1e] flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-editorial-subtle dark:text-gray-600">
          <span>© {new Date().getFullYear()} Devanshu Patil. All rights reserved.</span>
